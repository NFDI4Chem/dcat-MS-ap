# Contributing to dcat-ms-ap

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
dcat-ms-ap. These guidelines are not strict rules.
...
The dcat-ms-ap team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the dcat-ms-ap technical leads
...
[issues]: https://github.com/NFDI4Chem/dcat-ms-ap/issues/
[pulls]: https://github.com/NFDI4Chem/dcat-ms-ap/pulls/

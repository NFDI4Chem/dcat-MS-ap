...
--     * Slot: type_id Description: This slot is described in more detail within the class in which it is used.
--     * Slot: rdf_type_id Description: The slot to specify the ontology class that is instantiated by an entity.
-- # Class: MSAnalysisDataset_description
--     * Slot: MSAnalysisDataset_id Description: Autocreated FK slot
--     * Slot: description Description: A free-text account of the Dataset.
-- # Class: MSAnalysisDataset_identifier
--     * Slot: MSAnalysisDataset_id Description: Autocreated FK slot
...
--     * Slot: MSSpectroscopy_id Description: Autocreated FK slot
--     * Slot: title Description: The slot to provide a title for the Activity.
-- # Class: MSSpectroscopy_description
--     * Slot: MSSpectroscopy_id Description: Autocreated FK slot
--     * Slot: description Description: The slot to provide a description for the Activity.
...
CREATE TABLE "MSAnalysisDataset" (
...
CREATE TABLE "ChemicalSample" (
	...
	FOREIGN KEY(type_id) REFERENCES "DefinedTerm" (id),
	FOREIGN KEY(rdf_type_id) REFERENCES "DefinedTerm" (id)
);CREATE INDEX "ix_ChemicalSample_id" ON "ChemicalSample" (id);
...
CREATE TABLE "IUPACChemicalFormula" (
	...
	FOREIGN KEY(type_id) REFERENCES "DefinedTerm" (id),
	FOREIGN KEY(rdf_type_id) REFERENCES "DefinedTerm" (id)
);CREATE INDEX "ix_IUPACChemicalFormula_id" ON "IUPACChemicalFormula" (id);
CREATE TABLE "SMILES" (
	id INTEGER NOT NULL,
	title TEXT,
	description TEXT,
...
CREATE TABLE "MSAnalysisDataset_description" (
	"MSAnalysisDataset_id" TEXT,
	description TEXT NOT NULL,
	PRIMARY KEY ("MSAnalysisDataset_id", description),
	FOREIGN KEY("MSAnalysisDataset_id") REFERENCES "MSAnalysisDataset" (id)
);CREATE INDEX "ix_MSAnalysisDataset_description_description" ON "MSAnalysisDataset_description" (description);CREATE INDEX "ix_MSAnalysisDataset_description_MSAnalysisDataset_id" ON "MSAnalysisDataset_description" ("MSAnalysisDataset_id");
CREATE TABLE "MSAnalysisDataset_identifier" (
	"MSAnalysisDataset_id" TEXT,
	identifier TEXT,
...
CREATE TABLE "MSAnalysisDataset_keyword" (
	"MSAnalysisDataset_id" TEXT,
	keyword TEXT,
	PRIMARY KEY ("MSAnalysisDataset_id", keyword),
	FOREIGN KEY("MSAnalysisDataset_id") REFERENCES "MSAnalysisDataset" (id)
);CREATE INDEX "ix_MSAnalysisDataset_keyword_keyword" ON "MSAnalysisDataset_keyword" (keyword);CREATE INDEX "ix_MSAnalysisDataset_keyword_MSAnalysisDataset_id" ON "MSAnalysisDataset_keyword" ("MSAnalysisDataset_id");
CREATE TABLE "MSAnalysisDataset_title" (
	"MSAnalysisDataset_id" TEXT,
	title TEXT NOT NULL,
	PRIMARY KEY ("MSAnalysisDataset_id", title),
	FOREIGN KEY("MSAnalysisDataset_id") REFERENCES "MSAnalysisDataset" (id)
);CREATE INDEX "ix_MSAnalysisDataset_title_title" ON "MSAnalysisDataset_title" (title);CREATE INDEX "ix_MSAnalysisDataset_title_MSAnalysisDataset_id" ON "MSAnalysisDataset_title" ("MSAnalysisDataset_id");
CREATE TABLE "MSAnalysisDataset_version_notes" (
	"MSAnalysisDataset_id" TEXT,
	version_notes TEXT,
...
CREATE TABLE "MSAnalysis_title" (
	...
	FOREIGN KEY("MSAnalysis_id") REFERENCES "MSAnalysis" (id)
);CREATE INDEX "ix_MSAnalysis_title_MSAnalysis_id" ON "MSAnalysis_title" ("MSAnalysis_id");CREATE INDEX "ix_MSAnalysis_title_title" ON "MSAnalysis_title" (title);
...
CREATE TABLE "AnalysisDataset_description" (
	...
	FOREIGN KEY("AnalysisDataset_id") REFERENCES "AnalysisDataset" (id)
);CREATE INDEX "ix_AnalysisDataset_description_description" ON "AnalysisDataset_description" (description);CREATE INDEX "ix_AnalysisDataset_description_AnalysisDataset_id" ON "AnalysisDataset_description" ("AnalysisDataset_id");
...
CREATE TABLE "Dataset_version_notes" (
	...
	FOREIGN KEY("Dataset_id") REFERENCES "Dataset" (id)
);CREATE INDEX "ix_Dataset_version_notes_version_notes" ON "Dataset_version_notes" (version_notes);CREATE INDEX "ix_Dataset_version_notes_Dataset_id" ON "Dataset_version_notes" ("Dataset_id");
...
CREATE TABLE "NMRAnalysisDataset_keyword" (
	...
	FOREIGN KEY("NMRAnalysisDataset_id") REFERENCES "NMRAnalysisDataset" (id)
);CREATE INDEX "ix_NMRAnalysisDataset_keyword_NMRAnalysisDataset_id" ON "NMRAnalysisDataset_keyword" ("NMRAnalysisDataset_id");CREATE INDEX "ix_NMRAnalysisDataset_keyword_keyword" ON "NMRAnalysisDataset_keyword" (keyword);

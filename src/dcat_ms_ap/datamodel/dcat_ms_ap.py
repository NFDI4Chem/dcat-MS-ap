...
# Generation date: 2025-09-08T15:48:13
# Schema: dcat-ms-ap
#
...
class MSAnalysisDatasetId(DatasetId):
    pass
...
class MSSpectrumId(EvaluatedEntityId):
    pass
...
@dataclass(repr=False)
class MSAnalysisDataset(Dataset):
    """
    A dataset about one or multiple MSSpectrum of a ChemicalSample.
    """
    _inherited_slots: ClassVar[list[str]] = []
    ...
    title: Union[str, list[str]] = None
    was_generated_by: Union[dict[Union[str, DataGeneratingActivityId], Union[dict, DataGeneratingActivity]], list[Union[dict, DataGeneratingActivity]]] = empty_dict()
    is_about_entity: Optional[Union[dict[Union[str, MSSpectrumId], Union[dict, "MSSpectrum"]], list[Union[dict, "MSSpectrum"]]]] = empty_dict()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_list(slot_name="is_about_entity", slot_type=MSSpectrum, key_name="id", keyed=True)
...
@dataclass(repr=False)
class MSSpectrum(EvaluatedEntity):
    """
    ...
    has_scan_polarity: Union[str, "ScanPolarity"] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self._is_empty(self.has_scan_polarity):
            self.MissingRequiredField("has_scan_polarity")
        if not isinstance(self.has_scan_polarity, ScanPolarity):
            self.has_scan_polarity = ScanPolarity(self.has_scan_polarity)
...
# Enumerations
class ScanPolarity(EnumDefinitionImpl):
...
slots.has_scan_polarity = Slot(uri=DEFAULT_.has_scan_polarity, name="has_scan_polarity", curie=DEFAULT_.curie('has_scan_polarity'),
                   model_uri=DEFAULT_.has_scan_polarity, domain=None, range=Union[str, "ScanPolarity"])
...
slots.MSAnalysisDataset_is_about_entity = Slot(uri=DCTERMS.subject, name="MSAnalysisDataset_is_about_entity", curie=DCTERMS.curie('subject'),
                   model_uri=DEFAULT_.MSAnalysisDataset_is_about_entity, domain=MSAnalysisDataset, range=Optional[Union[dict[Union[str, MSSpectrumId], Union[dict, "MSSpectrum"]], list[Union[dict, "MSSpectrum"]]]])
...
slots.MSSpectrum_has_scan_polarity = Slot(uri=DEFAULT_.has_scan_polarity, name="MSSpectrum_has_scan_polarity", curie=DEFAULT_.curie('has_scan_polarity'),
                   model_uri=DEFAULT_.MSSpectrum_has_scan_polarity, domain=MSSpectrum, range=Union[str, "ScanPolarity"])
